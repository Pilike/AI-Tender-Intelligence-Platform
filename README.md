...
This repository presents the project as a Solutions Engineering and AI Implementation case study: the business problem, system architecture, delivery responsibilities, and technical judgment behind the work.
...
- [docs/data-model.md](docs/data-model.md) - conceptual data responsibilities.
- [docs/workflows.md](docs/workflows.md) - workflow families and design principles.
